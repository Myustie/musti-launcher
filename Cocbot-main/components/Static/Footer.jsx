                ...
                <div className="pt-10 mx-auto">
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                <img src="/img/SterkBOT.png" className="rounded-full w-12" />
                                <p className="font-semibold text-xl text-white"> SterkBOT </p>
                            </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://www.discord.com/users/980535852738441231">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                        ...
                        <div className="col-span-1">
                            <p className="text-white font-medium mt-3 sm:mt-0 sm:mb-3"> Diğer.. </p>
                            <div>
                                <Link href="/tos">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                                        Hizmet Koşulları
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; SterkBOT
                        </p>
